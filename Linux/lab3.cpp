	...
	case 0: // Дочерний процесс
		{
			...
			{
				message.clear();
				WaitSemaphore(sem_id, 2); // Ожидаем, пока счетчик семафора не станет равным 1
	...
	default: // Родительский процесс
		{
			...
			while(1)
			{
				...
				*(int*)buffer = length;
				...
				WaitSemaphore(sem_id, 3);  // Ожидание, пока счетчик семафоров не станет равным 1
				// и сброс в 0 по окончании ожидания
			}
...
// Ожидание, пока счетчик семафора не станет равным 1
// и сброс в 0 по окончании ожидания
void WaitSemaphore(int sem_id, int num)
{
	struct sembuf buf;
...
// Установить счетчик семафора в 1
void ReleaseSemaphore(int sem_id, int num)
{
	struct sembuf buf;
	buf.sem_op = 1;
